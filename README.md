>fork了大佬的仓库  想在自己跟着刷题的时候如果遇到问题可以记录下来，然后会删掉一些原来的说明什么的 
>
>基本流程是按照大佬给的list刷，先看一遍大致思路开始码，把遇到的问题易错点还有思路都记在新开的**练习**中（原本文档）
>
>此外新开了按照题型分类的list，随着我慢慢刷会一点一点加进去（遥遥无期emmm）——JJY
...
~~以下是一些原版看起来不太方便 所以被我移到最后的内容——JJY~~
